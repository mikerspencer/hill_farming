...
compare them to the census output area value, which is `r sum(census_OA$pop_working_land_2011)` people.
...
x=census %>%
   ...
   mutate(pop_working_land_2001=100 * pop_working_land_2001/pop_working_all_2001) %>% 
   select(PARName, pop_working_land_2001, A_agri)
