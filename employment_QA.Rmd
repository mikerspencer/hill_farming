...
The working in agriculture/forestry/fishing population for aggregated parishes in 2011 is `r round(sum(census$pop_working_land_2011))` people and for civic parishes `r sum(civ_parish_2011$A_agri/100 * civ_parish_2011$all, na.rm=T)` people.
compare them to the census output area value, which is `r sum(census_OA_2011$pop_working_land_2011, na.rm=T)` people.
The same values for 2001 are: aggregated agricultural parishes, `r round(sum(census$pop_working_land_2001))`; civic parishes `r sum(civ_parish_2001$A_agri/100 * civ_parish_2001$all, na.rm=T)` people; output areas `r sum(census_OA_2001$pop_working_land_2001)` people.
