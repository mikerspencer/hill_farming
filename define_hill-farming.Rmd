...
```{r urban-rural_map, fig.cap="Map of parish rural proportion"}
...
```{r SNH_wild_land, fig.cap="Map of parish SNH wild land proportion"}
...
```{r SNH_NNR, fig.cap="Map of parish National Nature Reserve proportion"}
