...
* SNH Wildland: <https://gateway.snh.gov.uk/natural-spaces/>
...
```{r slope}
plot.map("slope__average", "Slope median\n(degrees)")
```
...
Common grazing data were sent with units of Hectares per parish.
